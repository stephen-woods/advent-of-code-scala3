...
/** --- Day 2: Dive! ---
  ...
  *
  * --- Part Two --- Based on your calculations, the planned course doesn't seem
  * to make any sense. You find the submarine manual and discover that the
...
object Day02 {
  ...
  def run(): ZIO[Any, IOException, Unit] = {
    for {
      _ <- Console.printLine("--- Day 2: Dive! ---")
      _ <-
        Console.printLine(
